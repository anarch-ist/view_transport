...
public class TestTrackCourseAndDate {
    ...
    public void testGetTrackCoursesAndDates() {
        ...
        Iterator<Map.Entry<DateAndTrackCourse, LoadCostOfTrackCourse>> iterator = listOfCargoFlightByExactDateOfTrackCourse.entrySet().iterator();
        while (iterator.hasNext()){
            Map.Entry<DateAndTrackCourse, LoadCostOfTrackCourse> entry = iterator.next();
