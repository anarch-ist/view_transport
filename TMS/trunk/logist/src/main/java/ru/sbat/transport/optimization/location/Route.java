...
//            if(routePoint.getPoint().equals(point)){
//                return true;
//            }
//        }
//        return false;
...
//        return (this.get(this.size()-1).getPoint().equals(point));
//    }
//
...
//        return this.get(this.size()-1).getPoint();
//    }
//
...
//     */
//    @Override
//    public int getWeekDayOfActualArrivalDateInRoutePoint(RoutePoint routePoint) {
//        int result = 0;
...
//     */
//    @Override
//    public int getActualArrivalTimeInRoutePoint(RoutePoint routePoint) {
//        Date date = new Date();
//        for(RoutePoint routePointFromRoute: this) {
//            if (routePointFromRoute.equals(routePoint)) {
...
//        boolean result = true;
//        if(this.size() >= 1) {
//            if (this.get(this.size() - 1).getPoint().equals(routePoint.getPoint())) {
//                return false;
//            }
//        }
//        return result;
