...
public class TestOptimazer {
    ...
    public static void createPlannedSchedule(){
        ...
        routePoint4.setDayOfWeek(2); //(вт)
        routePoint4.setDepartureTime(930); // в минутах от начала суток 15:00
        ...
        routePoint7.setDepartureTime(975);// в минутах от начала суток 16:15
        ...
        routePoint8.setLoadingOperationsTime(104);
    ...
    public static void createUnassignedInvoices(){
        ...
        System.out.println(date + " планируемая дата доставки");
        ...
        System.out.println(creationDate + " дата создания накладной");
        System.out.println("");
    ...
    public void testGetPossibleDepartureDate(){
        ...
        RoutePoint routePoint1 = new RoutePoint();
        routePoint1.setDayOfWeek(3);
        routePoint1.setDepartureTime(930);
        routePoint1.setTimeToNextPoint(600);
        routePoint1.setLoadingOperationsTime(0);
        RoutePoint routePoint2 = new RoutePoint();
        routePoint2.setDayOfWeek(4);
        routePoint2.setDepartureTime(180);
        routePoint2.setTimeToNextPoint(960);
        routePoint2.setLoadingOperationsTime(90);
        RoutePoint routePoint3 = new RoutePoint();
        ...
        request.setPlannedDeliveryTime(plannedDate);
        invoice.setRequest(request);
        ...
        System.out.println(date + " дата создания накладной");
        System.out.println(result.get(0) + " дата возможного отъезда");
        System.out.println(plannedDate + " планируемая дата доставки в заявке");
        Assert.assertEquals(1, result.size());
        Assert.assertTrue(date.before(result.get(0)));
        Assert.assertTrue(plannedDate.after(result.get(0)));
    }
