...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="common_files/media/Editor-1.6.3/css/editor.bootstrap.min.css"/>
    ...
    <link rel="stylesheet" type="text/css" href="common_files/media/Select-1.2.0/css/select.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="common_files/media/Selectize/css/selectize.css"/>
    <link rel="stylesheet" type="text/css" href="common_files/media/Selectize/css/selectizebootstrap3.css"/>
    ...
    <!--    <script src="common_files/media/Buttons-1.2.2/js/dataTables.buttons.flash.min.js"></script>-->
    ...
    <script src="common_files/media/Editor-1.6.3/js/dataTables.editor.js" type="text/javascript"></script>
    <script src="common_files/media/Editor-1.6.3/js/editor.bootstrap.js" type="text/javascript"></script>
    <script src="common_files/media/FieldType-Mask/editor.mask.js" type="text/javascript"></script>
<!--    <script src="common_files/media/DataTables-1.10.10/js/jquery.dataTables.js" type="text/javascript"></script>-->
