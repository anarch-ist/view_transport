...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="common_files/media/DataTables-1.10.10/css/datatables.bootstrap.css"/>
<!--    <link rel="stylesheet" type="text/css" href="common_files/media/DataTables-1.10.10/css/jquery.dataTables.css"/>-->
    <link rel="stylesheet" type="text/css" href="common_files/media/font-awesome/css/font-awesome.min.css"/>
    <link rel="stylesheet" type="text/css" href="common_files/media/Buttons-1.1.0/css/buttons.bootstrap.css"/>
    <!--    <link rel="stylesheet" type="text/css" href="common_files/media/Buttons-1.1.0/css/buttons.dataTables.css"/>-->
...
<!--    <link rel="stylesheet" type="text/css" href="common_files/media/Editor-1.6.3/css/editor.dataTables.min.css"/>-->
    <link rel="stylesheet" type="text/css" href="content/css/routeLists.css">
    <!--    Custom css-->
    ...
    <script src="common_files/media/Buttons-1.1.0/js/buttons.bootstrap.js"></script>
<!--    <script src="common_files/media/Buttons-1.1.0/js/buttons.html5.js"></script>-->
    <script src="common_files/media/Select-1.1.0/js/dataTables.select.min.js"></script>
    <script src="common_files/media/Editor-1.5.4/js/dataTables.editor.js"></script>
    <script src="common_files/media/Editor-1.5.4/js/editor.bootstrap.js"></script>
    ...
    <script src="content/js/routeListsPage.js" type="text/javascript"></script>
...
<body>
<div class="container">
    <table  id="routeListsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>Внешний ID</th>
