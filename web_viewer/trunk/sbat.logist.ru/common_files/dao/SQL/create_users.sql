...
GRANT SELECT ON transmaster_transport_db.invoice_history TO 'andy'@'localhost';
GRANT SELECT ON transmaster_transport_db.invoice_statuses TO 'andy'@'localhost';
GRANT SELECT ON transmaster_transport_db.invoice_statuses_for_user_role TO 'andy'@'localhost';
GRANT SELECT, UPDATE, INSERT, DELETE ON transmaster_transport_db.invoices TO 'andy'@'localhost';
...
GRANT SELECT ON transmaster_transport_db.route_lists TO 'andy'@'localhost';
GRANT SELECT, UPDATE, INSERT, DELETE ON transmaster_transport_db.route_points TO 'andy'@'localhost';
GRANT SELECT ON transmaster_transport_db.routes TO 'andy'@'localhost';
