...
CREATE PROCEDURE transmaster_transport_db.selectDrivers(
  ...
  BEGIN
    ...
    WHERE (_search = '' OR
           ...
           license LIKE @searchString) AND deleted = FALSE
    ORDER BY NULL,
      CASE WHEN _orderby = ''
        THEN NULL END,
      CASE WHEN _isDesc AND  _orderby = 'id'
...
DROP PROCEDURE transmaster_transport_db.selectUsers;
...
CREATE PROCEDURE transmaster_transport_db.selectUsers(
  ...
  BEGIN
    ...
    WHERE (_search = '' OR
           ...
           phoneNumber LIKE @searchString OR
           email LIKE @searchString OR
           pointName LIKE @searchString OR
           userRoleRusName LIKE @searchString)
    ORDER BY NULL,
      CASE WHEN _orderby = ''
        THEN NULL END,
  ...
  END;DROP PROCEDURE transmaster_transport_db.selectTransportCompanies;
