<head xmlns:display="http://www.w3.org/1999/xhtml">
    ...
    <link rel="stylesheet" type="text/css" href="../common_files/media/Select-1.1.0/css/select.bootstrap.min.css"/>
    ...
    <script src="../common_files/media/DataTables-1.10.10/js/dataTables.bootstrap.min.js"></script>
    <script src="../common_files/media/Buttons-1.1.0/js/dataTables.buttons.min.js"></script>
    <script src="../common_files/media/Buttons-1.1.0/js/buttons.bootstrap.min.js"></script>
    <script src="../common_files/media/Editor-1.5.4/js/dataTables.editor.min.js"></script>
    <script src="../common_files/media/Editor-1.5.4/js/editor.bootstrap.min.js"></script>
...
<div class="row container-fluid">
    <div class="col-2">
        <ul class="nav nav-pills flex-column nav-stacked nav-sidebar" style="width: 200px; float: left">
            <li class="active"><a data-toggle="pill" href="#tabs-1"><i class="fa fa-compass" aria-hidden="true"></i> Маршруты</a></li>
            <li><a data-toggle="pill" href="#tabs-2"><i class="fa fa-users" aria-hidden="true"></i> Пользователи</a></li>
            <li><a data-toggle="pill"href="#tabs-3"><i class="fa fa-truck" aria-hidden="true"></i> ТК, ТС, <br>водители</a></li>
    ...
    <div class="col-lg-10 tab-content" id="tab-content" style="float: right">
                    ...
                    <div>
                        <table id="routeChangeSet">
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-default" id="updateDaysOfWeek" style="display: inline-block">Обновить</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-default" id="updateStartRouteTime">Обновить</button>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div>
                            <div style="width: 49%; display: inline-block">
                                <table class="table table-bordered table-striped " id="routePointsTable">
                                    <thead>
                                    <tr>
                            ...
                            <div style="width: 50%; display: inline-block">
                                <table class="table table-bordered table-striped " id="relationsBetweenRoutePointsTable">
                                    <thead>
                                    <tr>
        ...
        <div id="tabs-3" class="tab-pane fade">
            ...
            <div id="transportCompaniesCreation">
                <table class="table table-bordered table-striped " id="transportCompaniesTable">
                    <thead>
                    <tr>
                        <th>№ТК</th>
        ...
        <div id="tabs-4" class="tab-pane fade">
            <div id="requestsAssignment"><h2>Распределение заявок</h2><br>
                <div class="c-tooltip" >Как это работает?
                ...
                <input type="button" class="btn btn-default" disabled="disabled" id="assignRequests" value="Распределить">
