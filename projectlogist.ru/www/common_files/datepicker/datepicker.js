...
**/
	destroy: function() {
		...
		this.element.style.paddingLeft = this.oldPadding;
...
**/
	...
	drawCalendar: function(container, date) {
		...
		if (!this.options.range && this.options.timePicker) {
			...
			var timewrap = new Element('table', {'style': '#timetable, #timetable:hover {margin: 3px auto;  background-color: #EEE;border: none; ;text-shadow: none;}', 'id' : 'timetable'});
