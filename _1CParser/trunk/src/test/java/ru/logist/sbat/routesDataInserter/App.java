    ...
    public static void main(String[] args) throws ParseException, SQLException, IOException {
        ...
        try {
            ...
            dataBase = new DataBase(
                    inserterProperties.getProperty("url"),
                    inserterProperties.getProperty("dbName"),
                    inserterProperties.getProperty("user"),
                    inserterProperties.getProperty("password"),
                    inserterProperties.getProperty("encoding")
            );
        ...
        try {
            ...
            PreparedStatement pointsStatement = dataBase.getConnection().prepareStatement(
...
//         3) insert into routes from csv
        try {
            ...
            String line = "";
            PreparedStatement routesStatement = dataBase.getConnection().prepareStatement(
        ...
        Statement routePointsStatement = dataBase.getConnection().createStatement();
        ...
        Statement distancesBetweenPoints = dataBase.getConnection().createStatement();
